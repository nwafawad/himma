...
export default function LandingPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] py-12 text-center space-y-16">
      ...
      <ScrollReveal direction="up" delayMs={50} className="max-w-3xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4">
          <Link
            ...
            className="inline-flex min-h-11 items-center gap-2 rounded-full bg-charcoal hover:bg-black text-white px-7 py-3 text-sm font-medium transition-all shadow-md hover:shadow-lg active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-charcoal focus-visible:ring-offset-2"
          >
          ...
          <Link
            href="#features"
            className="inline-flex min-h-11 items-center gap-2 rounded-full bg-white hover:bg-card-muted text-charcoal border border-border-light px-7 py-3 text-sm font-medium transition-all hover:border-charcoal/30 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-charcoal focus-visible:ring-offset-2"
          >
      ...
      {/* Feature Grid */}
      <div id="features" className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl text-left pt-10 border-t border-border-light scroll-mt-24">
        {/* Feature 1 */}
