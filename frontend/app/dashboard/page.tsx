    ...
    <div className="space-y-10 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div
          ...
          className="p-6 bg-card border border-border-light rounded-2xl cursor-pointer hover:border-charcoal transition-all group shadow-sm hover:shadow-md"
        >
        ...
        <div className="p-6 bg-card border border-border-light rounded-2xl cursor-pointer hover:border-charcoal transition-all group shadow-sm hover:shadow-md">
          <div className="w-10 h-10 rounded-full bg-card-muted flex items-center justify-center text-charcoal mb-4 group-hover:bg-charcoal group-hover:text-white transition-colors">
