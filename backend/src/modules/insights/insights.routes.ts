...
import { createInsightRunInputSchema, feedbackInputSchema, idParamSchema } from '@himma/contracts';
 ...
 */
router.post('/', validateBody(createInsightRunInputSchema), createInsightRun);
 ...
 */
router.post('/:id/feedback', validateParams(idParamSchema), validateBody(feedbackInputSchema), postFeedback);
